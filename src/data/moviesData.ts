...
const additionalSearchMovies: SearchableMovieEntry[] = [
  ...
  { name: "Scam 1992", aliases: ["The Harshad Mehta Story"] },
  { name: "Arya", aliases: ["Aarya"] },
  { name: "The Family Man" },
  { name: "Sacred Games" },
  { name: "Delhi Crime" },
  { name: "Made in Heaven" },
  ...
  { name: "TVF Tripling", aliases: ["Tripling"] },
  { name: "Permanent Roommates" },
  { name: "Pitchers" },
  { name: "Humorously Yours" },
  { name: "ImMature" },
  { name: "Tech Conversations with Dad" },
  { name: "Kota Factory Season 2" },
  { name: "Rocket Boys Season 2" },
  { name: "The Family Man 2" },
  { name: "Mumbai Diaries 26/11 Season 2" },
  { name: "Scam 2003", aliases: ["The Telgi Story"] },
  { name: "Arya Season 2", aliases: ["Aarya Season 2"] },
  { name: "Special OPS 1.5" },
  { name: "Human Season 2" },
  { name: "The Great Indian Murder Season 2" },
  { name: "Rocket Boys Season 3" },
  { name: "Panchayat Season 2" },
  { name: "Gullak Season 2" },
  { name: "Aspirants Season 2" },
  { name: "Kota Factory Season 3" },
  { name: "College Romance Season 2" },
  { name: "TVF Tripling Season 2", aliases: ["Tripling Season 2"] },
  { name: "Permanent Roommates Season 2" },
  { name: "Pitchers Season 2" },
  { name: "Humorously Yours Season 2" },
  { name: "ImMature Season 2" },
  { name: "Tech Conversations with Dad Season 2" },
